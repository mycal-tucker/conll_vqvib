...
#    print(alignment_datasets[0])
        ...
        for p_train in settings.prob_notseedist:
            print(p_train)
            ...
            model_to_eval_path = 'src/saved_models/' + folder_training_type + folder_ctx + 'kl_weight' + str(settings.kl_weight) + '/seed' + str(seed) + '/1999'
            ...
            eval_model_training(model, vae_model, c_dim, p_train, val_data, viz_data, glove_data, num_cand_to_metrics, save_eval_path, fieldname='topname', calculate_complexity=do_calc_complexity, plot_comms_flag=do_plot_comms)
